      ...
      if (mode === "automatic") {
        try {
          ...
          if (Math.abs(fetchedPrice - effectivePrice) < priceThreshold) {
            ...
            alert(
              "قیمت تغییر کرده است. لطفاً دوباره دکمه ثبت معامله را بزنید."
            );
          }
        } catch (error) {
        ...
        <ToggleButtonGroup
          ...
          sx={{
            ...
            "& .MuiToggleButton-root": {
              ...
              px: 1,
              py: 0.5,
              borderRadius: 0, // برداشتن گوشه‌های گرد برای دکمه‌های داخلی
              "&.Mui-selected": {
                backgroundColor: "rgb(25, 118, 211)", // رنگ پس‌زمینه برای دکمه انتخاب شده
                color: "#fff", // رنگ متن برای دکمه انتخاب شده
                "&:hover": {
                  backgroundColor: "rgba(0, 128, 0, 0.7)", // رنگ پس‌زمینه هنگام هاور بر روی دکمه انتخاب شده
                },
              },
              "&:not(:last-child)": {
                borderRight: "1px solid rgba(0, 0, 0, 0.12)", // اضافه کردن خط جداکننده بین دکمه‌ها
              },
              "&:first-child": {
                borderRadius: "4px 0 0 4px", // گوشه‌های گرد برای اولین دکمه
              },
              "&:last-child": {
                borderRadius: "0 4px 4px 0", // گوشه‌های گرد برای آخرین دکمه
              },
            },
          }}
        >
